...
from .views import CreateDateView, vote_up, vote_down, list_home, list_home_today, list_home_yesterday, list_home_tomorrow


urlpatterns = [
    path('', list_home, name="list_home"),
    path('<int:date>/', CreateDateView.as_view(), name='list_date'),
